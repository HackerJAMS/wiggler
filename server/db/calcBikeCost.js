...
var subSetQuery = function(countStart, countEnd) {
  ...
  var queryString = "SELECT gid, length, ST_AsText(ST_Transform(the_geom,4326)) FROM ways WHERE class_id NOT IN (101,102,103,104,106,107,105,122,112,115) AND count >=" + countStart + "AND count <"+ countEnd;
