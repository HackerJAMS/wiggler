...
//##########################################################
    ...
    // <strong>' + (feature.properties.elevation * 3.28).toFixed(0) + ' ft </strong>
    
    L.geoJson(turfElevation, {
      pointToLayer: function(feature, latlng) {
        var myIcon = L.divIcon({
          className: 'markerline',
          html: '<div class="elevmarker"><div class="markercircle bottomcap"></div><div class="markerline" style="height:' + feature.properties.elevation + 'px">' + '</div><div class="markercircle"></div><div class="elevfigure"><span style="font-size:0.9em"></span></div>'
        });
